...
impl StrategiesWorker {
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies nats workers atr {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies nats workers zlema {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies nats workers ha zlema {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies nats workers kdj {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies nats workers bbands {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies nats workers ichimoku cloud {symbol:} {interval:}");
