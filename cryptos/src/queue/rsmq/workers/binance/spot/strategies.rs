...
impl StrategiesWorker {
    ...
    T: AsRef<str>
  {
    ...
    println!("binance spot strategies rsmq workers process {symbol:} {interval:}");
  ...
  {
    println!("binance spot strategies rsmq workers subscribe");
    workers.spawn(Box::pin({
      ...
      async move {
        ...
        loop {
          println!("binance spot strategies rsmq loop");
