...
use crate::queue::rsmq::payload::binance::futures::indicators::*;
...
impl IndicatorsWorker {
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers pivot {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers atr {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers zlema {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers ha zlema {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers kdj {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers bbands {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers ichimoku cloud {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers volume profile {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers andean oscillator {symbol:} {interval:}");
    ...
    T: AsRef<str>
  {
    ...
    println!("binance futures indicators rsmq workers process {symbol:} {interval:}");
  ...
  {
    println!("binance futures indicators rsmq workers subscribe");
    workers.spawn(Box::pin({
      ...
      async move {
        ...
        loop {
          println!("binance futures indicators rsmq loop");
