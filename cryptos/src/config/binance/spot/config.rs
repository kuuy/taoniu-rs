...
pub const RSMQ_QUEUE_TRADINGS_LAUNCHPAD: &str = "binance.spot.tradings.launchpad";
...
pub const RSMQ_JOBS_KLINES_UPDATE: &str = "binance:spot:klines:update";
...
pub const NATS_EVENTS_STRATEGIES_UPDAT: &str = "binance.spot.strategies.update";
