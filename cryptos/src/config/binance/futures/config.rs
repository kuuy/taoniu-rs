...
pub const LOCKS_TASKS_KLINES_FLUSH: &str = "locks:binance:futures:tasks:klines:flush";
pub const LOCKS_TASKS_KLINES_FIX: &str = "locks:binance:futures:tasks:klines:fix";